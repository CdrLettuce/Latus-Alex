...
*/
     ...
     *              condition(s)  (string  value using parameters )  Example: ' customer_id = :customer_id AND sales_id=:id'
     *              condition_values - associative array (field => value ) of parameter values  for named parameters in the condition
     *              Example: condition_values = array('customer_id'=>100, 'sales_id'=>4)  Note: do not include ':' when defining field
     * return bool
     */
     ...
     * Syntax: insertRecord($table, $parameter_values)
     * Parameters:  database table,  associative array of data to insert (field => value)
         *                              example: array('customer_id'=>100, 'sales_id'=>6)
     * return bool
     */
