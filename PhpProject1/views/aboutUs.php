...
<div class="gray about">
    <div class="container">
        <div class="row">
            <div class="col-sm-offset-1 col-sm-5 mission">
            ...
            <div class="col-sm-offset-0 col-sm-5 mission">
                ...
                <div class="col-sm-offset-1 col-sm-5">
                    ...
                    <div class="card">
                        <div class="image-cropper">
                            <img class="resize" src="../images/player.jpg" alt="Avatar" style="width:100%">
                        </div>
                        <div class="card-c">
        ...
        <div class="container started">
            <div class="row">
                <div class="col-sm-offset-1 col-sm-10">
                    <h2 class = "section">How RecruitChute Started</h2>
                    <h4 class="pbody">RecruitChute was founded by Manchester, England native Christopher Roche who was recruited over to play college soccer 
                    ...
                    Chris is revolutionizing the way that high school athletes and college coaches interact and communicate. </h4>
                </div>
            </div>
        </div>
