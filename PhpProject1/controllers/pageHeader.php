...
<div  class='row' id='outer-box' ><!-- outer box -->
 ...
 <div class='col-xs-3'>
        ...
        <p>Select Subject:
		<select  id='compsci-subject'>
			<option value='COMPSCI'>Computer Science Schedule</option>
                        <option value='MATH'>Math Science Schedule</option>
		</select>
	<p><span class = 'link' id='faculty-list'>Faculty</span></p>
 </div>
