...
<div id="messages-container" class="" ng-controller='messagesController as ex'>  
    <div id='messagesResults' class='row container-fluid'>
                    ...
                    <div>
                        <table class='table-striped table-side-messages'>
                            <tr ng-repeat='item in ex.inboxMessages track by $index'>
                                <td class='col-xs-12'>
                                    <a ng-click='ex.displayBigInboxMessage(item)'>
                                        <p><b>From: {{item.first_name}} {{item.last_name}}</b></p>
                    ...
                    <div>
                        <table class='table-striped table-side-messages'>
                            <tr ng-repeat='item in ex.outboxMessages track by $index'>
                                <td class='col-xs-12'>
                                    <a ng-click='ex.displayBigOutboxMessage(item)'>
                                        <p><b>To: {{item.first_name}} {{item.last_name}}</b></p>
                                        <p>Subject: {{item.subject}}</p>
                                        <p>Time: {{item.time_sent}}</p>
                                    </a>
                                </td>
        ...
        <div  id='messages-main' class='col-sm-8 xtra-top-marg' >
            ...
            <div id ="current-message" class="row-container-fluid col-sm-12" ng-show="ex.inboxBigMessage">
                ...
                <div id='selected-message-reply' class="col-sm-12">
                    <div class='col-sm-12 no-pad'>
                        ...
                        <div id="reply-subject" class="col-sm-10">
                            <input type="text" id="your-subject"  ng-model="ex.inboxMessage.replysubject">
                        </div>
                    </div>
                    <div class='col-sm-12 no-pad'>
                        <div class="col-sm-2">
                        ...
                        <div id="your-message" class="col-sm-10">
                            <textarea  class="form-control" name="bio" id="bio" ng-model='ex.inboxMessage.replymessage'></textarea>
                        </div>
                    </div>
                    <div class='col-sm-12 no-pad'>
                        <div class="col-sm-3 col-sm-offset-9">
                            <button ng-click="ex.inboxReply(ex.inboxMessage)" id="reply-button" class=' btn btn-primary'>Reply to {{ex.bigMessage.first_name}}</button>
                        </div> 
                    </div>
                </div>
            </div>
            <div id ="current-message" class="row-container-fluid col-sm-12" ng-show="ex.outboxBigMessage">
                <div id='selected-message-content'>
                    <div id="message-subject"class="col-sm-12">
                        <h3>{{ex.bigMessage.subject}}</h3>
                    </div>
                ...
                <div id='selected-message-reply' class="col-sm-12">
                    ...
                    <div class='col-sm-12 no-pad'>
                        <div class="col-sm-3 col-sm-offset-9">
                            <button ng-click="ex.outboxReply(ex.bigMessage)" id="reply-button" class=' btn btn-primary'>Send to {{ex.bigMessage.first_name}}</button>
                        </div> 
                    </div>
                </div>
            </div> 
